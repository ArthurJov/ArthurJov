...
<br/>
<div align="center">
  <a href="mailto:arthurjov29@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email"></a>
...
Sou graduando em **Engenharia de Software** (UNIJORGE) e Técnico em Desenvolvimento de Sistemas (SENAI). Meu foco é construir soluções inovadoras que conectam o **Desenvolvimento Web** à **Inteligência Artificial**.

* 🎓 **Atuação:** Tutor de Lógica de Programação e Líder de Turma (auxiliando ~30 alunos/semana).
* 🗣️ **Idiomas:** Português (Nativo) e Inglês Avançado (C1 - EF SET).
...
<table align="center" border="0">
  <tr>
    ...
    <td width="50%" align="center" valign="top">
      ...
      <a href="https://github.com/arthurjov/SiteCorretora"><b>🔗 Repositório</b></a>
    </td>
  </tr>
</table>
...
<table align="center" border="0">
  <tr>
    <td width="50%" align="center" valign="top">
      <h4>💎 DyLuxo — Loja de Joias</h4>
      <img src="https://img.shields.io/badge/Status-Em_Desenvolvimento-FFD700?style=flat-square" alt="Em Desenvolvimento" />
      <p>Projeto acadêmico UNIJORGE focado em estruturação de UI/UX e usabilidade.</p>
    ...
    <td width="50%" align="center" valign="top">
      ...
      <p>Landing page responsiva de eletrônicos, projeto final no SENAI com foco em design moderno.</p>
